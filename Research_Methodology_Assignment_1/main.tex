...
\begin{itemize}
Packet Capture: Use of Wireshark, Snort, and tcpdump to identify suspicious traffic flows (\cite{alenezi2023digital}).
...
\newpage
\begin{landscape}
\section{APPENDIX A: INDIVIDUAL ARTICLE REVIEW MATRIX}
\begin{table}[H]
\centering
\footnotesize
\renewcommand{\arraystretch}{1.3}
\textbf{Student: [Name / Student ID]} \\[0.2cm]
\caption{Individual article review contributions by group members}
\vspace{0.3cm}
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}p{2cm}|>{\raggedright\arraybackslash}p{1.8cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
\hline
\textbf{Student} & \textbf{Article} & \textbf{Research Problem} & \textbf{Objective} & \textbf{Methodology} & \textbf{Dataset / Sample} & \textbf{Key Findings} & \textbf{Limitations} & \textbf{Research Gap} \\ \hline
\textbf{Student 1} & xx & xx & xx & xx & xx & xx & xx & xx \\ \hline
\textbf{Student 1} & xx & xx & xx & xx & xx & xx & xx & xx \\ \hline
\textbf{Student 1} & xx & xx & xx & xx & xx & xx & xx & xx \\ \hline
...
\renewcommand{\arraystretch}{1.3}
\textbf{Student: [Name / Student ID]} \\[0.2cm]
\caption{Individual article review contribute by group members}
\vspace{0.3cm}
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}p{2cm}|>{\raggedright\arraybackslash}p{1.8cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
\hline
\textbf{Student} & \textbf{Article} & \textbf{Research Problem} & \textbf{Objective} & \textbf{Methodology} & \textbf{Dataset / Sample} & \textbf{Key Findings} & \textbf{Limitations} & \textbf{Research Gap} \\ \hline
...
\footnotesize
\renewcommand{\arraystretch}{1.3}
\textbf{Student: Nur Afiqah Ramli / 251UC2514E} \\[0.2cm]
\caption{Individual article review contributions by group members}
\vspace{0.3cm} 
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}p{2cm}|>{\raggedright\arraybackslash}p{1.8cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
\hline
\textbf{Student} & \textbf{Article} & \textbf{Research Problem} & \textbf{Objective} & \textbf{Methodology} & \textbf{Dataset / Sample} & \textbf{Key Findings} & \textbf{Limitations} & \textbf{Research Gap} \\ \hline
\textbf{Nur Afiqah Ramli} & Sanna et al. (2025) & Traditional digital forensics struggles with complex anti-forensics like steganography and high data volumes. & To map AI techniques to the NIST 4-phase DF process and test LLM capabilities. & Qualitative framework proposal combined with empirical case studies. & Steganographic images and functional Python scripts generated by LLMs; GitHub datasets. & AI enhances all 4 DF phases. LLMs utilized LSB but failed to decode images via upload. & Small scope; no automated countermeasures proposed for the generated threats. & Lack of automated countermeasures and testing across anti-forensic techniques. \\ \hline
\textbf{Nur Afiqah Ramli} & Alenezi (2023) & Retrieving and preserving digital evidence across decentralized smart environments is highly complex. & To survey recent advancements and challenges in retrieving evidence across IoT. & Comprehensive literature survey and categorization of smart environment forensics. & Recent literature and state-of-the-art tools focusing on smart environments and IoT. & Identified 4 advancement categories and 6 challenge categories (data heterogeneity). & Broad scope lacks deep empirical data; limited depth in specific IoT scenarios. & Need for standardized protocols for smart environments and empirical validation. \\ \hline
\textbf{Nur Afiqah Ramli} & Vaddi et al. (2024) & Rapid evolution of cybercrime necessitates intelligent tools for complex domains. & To review digital forensic evolution over 5 years focusing on AI and cloud. & Literature review and statistical analysis of long-standing and recent techniques. & Unstructured crime report narratives and literature patterns post-2018. & AI, blockchain, and deep learning drastically improve forensic capabilities in cloud/IoT. & Specific empirical testing details and localized datasets are limited in scope. & Bridging the gap between theoretical frameworks and real-world deployment. \\ \hline
...
\newpage
\begin{landscape}
\section{APPENDIX B: ARTICLE MATRIX}
\begin{table}[H]
\centering
\footnotesize
\renewcommand{\arraystretch}{1.3}
...
\vspace{0.3cm}
\begin{tabularx}{\linewidth}{|l|l|c|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
\hline
\textbf{Article} & \textbf{Student} & \textbf{Year} & \textbf{Method} & \textbf{Dataset} & \textbf{Key Results} & \textbf{Strength} & \textbf{Limitation} & \textbf{Research Gap} \\ \hline
1 & Student 1 & & & & & & & \\ \hline
2 & Student 1 & & & & & & & \\ \hline
3 & Student 1 & & & & & & & \\ \hline
4 & Student 2 & & & & & & & \\ \hline
...
8 & Student 3 & & & & & & & \\ \hline
9 & Student 3 & & & & & & & \\ \hline
10 & Nur Afiqah Ramli & 2025 & Qual/Case Study & LLM outputs & AI aids NIST pipeline & Practical scripts & Small scope & Automated defense \\ \hline
11 & Nur Afiqah Ramli & 2023 & Survey & Literature & Framework standardization needed & Broad view & Lacks deep data & IoT specific empiricals \\ \hline
12 & Nur Afiqah Ramli & 2024 & Review/Stats & Narratives & AI/Blockchain efficiency & Strategic guide & Lacks localized sets & Real-world deployment \\ \hline
